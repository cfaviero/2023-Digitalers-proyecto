...
if (currentUser) {
    ...
    if (currentUser.role === 'ROLE_ADMIN'){
        //*Deberiamos pintar dichos botones
        ...
        //* Si necesito agregarle la clase active al boton
        const url = window.location.pathname;
        if (url.includes('admin.html')) {
            adminProductLink.className.add('active');
        }
...
//-.trim() elimina los espacios de datos ingresados
} else {
